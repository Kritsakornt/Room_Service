                        ...
                        <div class="left">
                            <div class="contact">
                                <form v-on:submit.prevent="onLogin">
                                    ...
                                    <p></p>
                                    <div class="top_link"><a v-on:click="navigateTo('/user/create')"><img src="https://drive.google.com/u/0/uc?id=16U__U5dJdaTfNGobB_OpwAJ73vM50rPV&export=download" alt="">Register</a></div>
                                    <br>
                                    <center><dev class = "error" v-if="error">{{error}}</dev></center>
                                    <button class="submit">LOGIN IN</button>
                                </form>
                            </div>
                        </div>
                        <div class="right">
                            <div class="right-text">
                                <h2>ระบบเช่าหอพัก</h2>
                                <h5>เราดูแลห้อง ให้ห้องดูแลคุณ</h5>
                            </div>
                        </div>
                    </div>
                </section>
