    ...
    <b-row class="text-left">
         ...
         <b-col cols="10" class="bg3">
          <center>
            ...
            <h5>แก้ไขรายการแจ้งซ่อมที่ {{ comment.id }}</h5>
          </center>
          <hr>
          <form class="box3" v-on:submit.prevent="editComment">
            <p><b><h5><strong> หัวข้อที่จะเเจ้งซ่อม  </strong></h5></b><input type="text" class="form-control" v-model="comment.title" /></p>
      ...
      <hr>
      <p>
        <b-button variant="warning"  type="submit">ยืนยันการแก้ไขรายการ</b-button>
